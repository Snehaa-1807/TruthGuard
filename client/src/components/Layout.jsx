...
const NAV = [
  ...
  { to: "/check",     label: "Check News", icon: "⌕" },
    ...
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh", background: "var(--bg)" }}>
      <nav style={{
        ...
        <NavLink to="/dashboard" style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 34, height: 34, borderRadius: 9, background: "var(--primary)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 17 }}>
            🛡
          </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          <button className="btn btn-ghost" style={{ padding: "6px 14px", fontSize: "0.82rem" }} onClick={handleLogout}>
            Sign Out
          </button>
        </div>
      </nav>
